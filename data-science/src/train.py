...
def main(args):
    ...
    y_train = train_df["price"].values  # 'failure' is the target variable in this case study
    ...
    y_test = test_df["price"].values  # 'failure' is the target variable for testing
    ...
    mlflow.log_param("model", "Price Calculation Used Cars")  # Provide the model name
